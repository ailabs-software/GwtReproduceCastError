...
var $strongName = '343919BB85F6BDD2E2E9C232A601CAFE';
var $gwt = {};
...
function toString_0(object){
  if (Array.isArray(object) && object.typeMarker === typeMarkerFn) {
    return $getName(instanceOfString(object)?Ljava_lang_String_2_classLit:hasJavaObjectVirtualDispatch(object)?object.___clazz:isJavaArray(object)?object.___clazz:object.___clazz || Array.isArray(object) && getClassLiteralForArray(Lcom_google_gwt_core_client_JavaScriptObject_2_classLit, 1) || Lcom_google_gwt_core_client_JavaScriptObject_2_classLit) + '@' + (hashCode__I__devirtual$(object) >>> 0).toString(16);
  }
...
function $onModuleLoad(){
  ...
  if (instanceOf(myvalue, 8)) {
    throw toJs(new Error_0('Never happens'));
  }
}
