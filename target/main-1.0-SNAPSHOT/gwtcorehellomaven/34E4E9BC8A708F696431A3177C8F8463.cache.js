...
var $strongName = '34E4E9BC8A708F696431A3177C8F8463';
var $gwt = {};
...
function $onModuleLoad(){
  var e, o, someNativeObject;
  new ArrayList;
  someNativeObject = new $wnd.Array;
  o = someNativeObject.length;
  $wnd.alert('test' + o);
  try {
    $alert('is number a list? should be false: ' + instanceOf(o, 9));
  }
   catch ($e0) {
    $e0 = toJava($e0);
    if (instanceOf($e0, 5)) {
...
defineClass(8, 18, {8:1, 4:1, 5:1, 3:1}, JavaScriptException);
  ...
  for (i = 0 , j = tasks.length; i < j; i++) {
    ...
    try {
      ...
      if (instanceOf($e0, 3)) {
        e = $e0;
        $clinit_Impl();
        reportToBrowser(instanceOf(e, 8)?(checkCriticalType(e == null || canCast(e, 8)) , e).getThrown():e);
      }
       else 
        throw toJs($e0);
    }
...
defineClass(15, 7, $intern_0, ClassCastException);
...
defineClass(22, 7, $intern_0, IndexOutOfBoundsException);
...
stringCastMap = {4:1, 14:1, 45:1, 2:1};
...
defineClass(9, 43, {4:1, 9:1, 29:1}, ArrayList);
...
defineClass(28, 7, $intern_0, NoSuchElementException);
